...
def _get_distributed_executor_factory(
  ...
  if distributed_config is None or (
      distributed_config.server_mesh is None
      and distributed_config.client_mesh is None
  ):
    raise ValueError("Both server side and client side mesh are unspecified.")
